...
class AppTheme {
  static ThemeData lightTheme = ThemeData(
    ...
    bottomNavigationBarTheme: BottomNavigationBarThemeData(
      backgroundColor: CustomColors.textFieldColor1,
    ),
  ...
  static ThemeData darkTheme = ThemeData(
    ...
    textTheme: const TextTheme(
      ...
      displaySmall: TextStyle(color: CustomColors.textFieldColor1),
    ...
    buttonTheme: ButtonThemeData(
      ...
      inputDecorationTheme: InputDecorationTheme(
        fillColor: CustomColors.textFieldColor1,
...
class AppTextStyle {
  ...
  // static OtpFieldStyle vOtpInput = OtpFieldStyle(
  //   enabledBorderColor: CustomColors.primary,
  //   borderColor: CustomColors.primary,
  //   focusBorderColor: CustomColors.primary,
  //   disabledBorderColor: CustomColors.primary,
  //   errorBorderColor: CustomColors.primary,
  //   backgroundColor: CustomColors.white,
  // );
}